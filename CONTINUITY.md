...
- **Key decisions:**
  ...
  - Dispatch fail → retry + home-visit task; tin nhắn cá nhân status=failed = danh sách cần đến nhà.
- **State:**
  ...
  - **Now:** chờ user quyết Supabase creds + có muốn frontend/commit. Chưa commit.
