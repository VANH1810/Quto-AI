"""Danh mục 45 xã/phường Điện Biên (sau sắp xếp ĐVHC 2025) + toạ độ cho bản đồ.

Toạ độ/độ cao là XẤP XỈ theo khu vực (former district) để trình diễn bản đồ + hiệu
chỉnh rét hại theo độ cao; sản phẩm thật nạp ranh giới chính thức (PostGIS) + DEM
Copernicus GLO-90. Mức nhạy cảm lũ quét/sạt lở theo tinh thần QĐ18/2021 (Điện Biên
thuộc Khu vực 1 — nhạy cảm cao).
"""
